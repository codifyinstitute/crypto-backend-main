const brlStaticSchema = require('../Models/brlStaticSchema');
...
exports.addStaticData = async (req, res) => {
    try {
        ...
        const newStaticData = new brlStaticSchema({ TransactionFee, LoginId, Password, MinAmount, NetworkFee, Binance: binance, Coinbase: coinbase, Kraken: kraken, Wazirx: wazirx });
...
exports.getAllStaticData = async (req, res) => {
    try {
        const staticData = await brlStaticSchema.find();
...
exports.getOneStaticData = async (req, res) => {
    try {
        const staticData = await brlStaticSchema.findOne();
...
exports.getStaticDataById = async (req, res) => {
    try {
        const { id } = req.params;
        const staticData = await brlStaticSchema.findById(id);
...
exports.updateStaticData = async (req, res) => {
    try {
        ...
        const updatedStaticData = await brlStaticSchema.findByIdAndUpdate(
            id,
...
exports.deleteStaticData = async (req, res) => {
    try {
        ...
        const deletedStaticData = await brlStaticSchema.findByIdAndDelete(id);
...
exports.loginUser = async (req, res) => {
    ...
    try {
        const user = await brlStaticSchema.findOne({ LoginId });
        if (!user) {
