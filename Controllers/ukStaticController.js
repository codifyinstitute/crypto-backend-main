const ukStaticSchema = require('../Models/ukStaticSchema');
...
exports.addStaticData = async (req, res) => {
    try {
        ...
        const newStaticData = new ukStaticSchema({ TransactionFee, LoginId, Password, MinAmount, NetworkFee, Binance: binance, Coinbase: coinbase, Kraken: kraken, Wazirx: wazirx });
...
exports.getAllStaticData = async (req, res) => {
    try {
        const staticData = await ukStaticSchema.find();
...
exports.getOneStaticData = async (req, res) => {
    try {
        const staticData = await ukStaticSchema.findOne();
...
exports.getStaticDataById = async (req, res) => {
    try {
        const { id } = req.params;
        const staticData = await ukStaticSchema.findById(id);
...
exports.updateStaticData = async (req, res) => {
    try {
        ...
        const updatedStaticData = await ukStaticSchema.findByIdAndUpdate(
            id,
...
exports.deleteStaticData = async (req, res) => {
    try {
        ...
        const deletedStaticData = await ukStaticSchema.findByIdAndDelete(id);
...
exports.loginUser = async (req, res) => {
    ...
    try {
        const user = await ukStaticSchema.findOne({ LoginId });
        if (!user) {
